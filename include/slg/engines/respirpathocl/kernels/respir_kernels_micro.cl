...
__kernel void SpatialReuse_MK_INIT(
    ...
    */
    ...
    Respir_InitSpatialReuseIteration(spatialReuseData, numSpatialNeighbors, 
        &spatialReuseData->spatialReuseReservoir, reservoir, 
        pixelIndexMap, filmWidth, sampleResult->pixelX, sampleResult->pixelY, 
        &pathStates[gid]);
}
...
__kernel void SpatialReuse_MK_NEXT_NEIGHBOR(
    ...
    while (true) {
        ...
        if (Respir_UpdateNextNeighborGid(
            ...
            spatialRadius, pixelIndexMap, filmWidth, filmHeight,
...
__kernel void SpatialReuse_MK_FINISH_ITERATION(
    ...
    *central = *srReservoir;
    ...
    // Set up next spatial reuse iteration
    Respir_InitSpatialReuseIteration(spatialReuseData, numSpatialNeighbors, 
        srReservoir, central, 
        pixelIndexMap, filmWidth, sampleResult->pixelX, sampleResult->pixelY, 
        &pathStates[gid]);
